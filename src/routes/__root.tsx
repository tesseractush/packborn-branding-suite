...
import logoUrl from "../assets/packborn-logo.png";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Packborn — Packaging that Builds Brands, Not Just Boxes" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Packborn — Packaging that Builds Brands" },
      {
        ...
        content:
          "Custom packaging and branding for restaurants, cafés, cloud kitchens, and local businesses in India.",
      },
